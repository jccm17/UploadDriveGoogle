...
// PRIVATE!
    ...
    public static void main(String[] args) throws IOException {
        ...
        java.io.File uploadFile = new java.io.File("C:/Users/jccm1/credentials/credentials.json");
 
        // Create Google File:
 
        File googleFile = createGoogleFile(null, "json/plain", "credentials.json", uploadFile);
